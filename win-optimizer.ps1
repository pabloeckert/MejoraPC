...
function Show-Menu {
    ...
    Write-Host "  ║           WIN OPTIMIZER v2.1.0                       ║" -ForegroundColor Cyan
    ...
    Write-Host "  [E] 📤  Exportar benchmark para otra PC" -ForegroundColor Cyan
...
do {
    ...
    switch ($choice.ToUpper()) {
        ...
        "E" { & "$ScriptsDir\share-benchmark.ps1" -Action export; pause }
